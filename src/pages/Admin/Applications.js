...
const ShowDetails = ({ details, setDetails }) => {
  ...
  return (
    <div className="bg-white">
      ...
      <form action="" className="mx-2 mt-2" onSubmit={handleAdmit}>
        <div>
          <label className=" text-gray-600 dark:text-white" htmlFor="dob">
            Set Roll for {studentNameEnglish} :
          </label>
          <input
            type="text"
            value={rollNumber}
