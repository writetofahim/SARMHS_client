...
const Admission = () => {
  ...
  //   try {
  //     const response = await axiosInstance.post("admission", formData);
      ...
      <div className="max-w-[1200px] w-full mx-auto p-3 md:flex gap-5">
        <div className="w-full mx-auto">
          ...
          {admissionId ? (
            ...
            //     ভর্তি সম্পর্কিত তথ্য জানতে এই ফরমটি পূরণ করুন। অতি দ্রুত আমাদের
            //     একজন প্রতিনিধি আপনার সাথে যোগাযোগ করবেন।
            //   </p>
